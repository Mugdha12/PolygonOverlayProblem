...
congressDistrictShapeFile <-sf::st_read("/Users/mugdhachowdary/Downloads/C2012", layer = "C2012")
congressDistrict <- select(congressDistrictShapeFile, ID, AREA,DISTRICT)
zipcodeShapeFile <- sf::st_read("/Users/mugdhachowdary/Downloads/tl_2010_27_zcta510",  layer = "tl_2010_27_zcta510")

nzipcodeShapeFile <- sf::st_read("/Users/mugdhachowdary/Downloads/shp_bdry_zip_code_tabulation_areas",  layer = "zip_code_tabulation_areas")
...
congressDistrictPopulation <- DEC_10_SF1_P1_with_ann_CD
...
zipcodePopulation <- DEC_10_SF1_P1_with_ann
